...
public class GameAccountService {
    ...
    public void createGameAccount(String newName, Integer newLevel, TierType newTier) {
        try {
            insertQueryEntityManager.insertGameAccount(newName, newLevel, newTier);
        } catch (Exception e) {
            log.error("Failed to create a new GameAccount", e);
            throw e;
        }
    }
    
    // removable
    public void removeGameAccount(Long GameAccountID) {
        try {
            //
            deleteQueryEntityManager.deleteGameAccount(GameAccountID);
        } catch (Exception e) {
